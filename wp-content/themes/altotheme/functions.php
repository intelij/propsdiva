...
function lt_scripts() {
    ...
    wp_enqueue_script( 'custome-scripts-js', get_template_directory_uri() .'/js/scripts.js', array(), false , true );
...
/**
 * @snippet       Change out of stock to temporarily unavailable
...
function custom_get_availability( $availability, $_product ) {
    ...
    if ( !$_product->is_in_stock() ) $availability['availability'] = __('Temporarily Unavailable.', 'woocommerce');
        return $availability;
    }

/**
 * @snippet       Display random product in shop page
...
function custom_woocommerce_get_catalog_ordering_args( $args ) {
    ...
    // var_dump($orderby_value); die();
    if ( 'random_list' == $orderby_value || 'menu_order' == $orderby_value ) {
        $args['orderby'] = 'rand';
        $args['order'] = '';
        $args['meta_key'] = '';
    }

<?php
function lt_sc_brands( $atts, $content = null ){
		...
		<div class="lt-brands">
			<div class="row">
				<?php if($layout=='carousel'){ ?>
					<div class="brands-group lt-slider owl-carousel" data-loop="true" data-speed="1000" data-columns="<?php echo esc_attr($columns_number);?>" data-columns-small="<?php echo esc_attr($columns_number_small); ?>" data-columns-tablet="<?php echo esc_attr($columns_number_tablet); ?>">
...
add_shortcode('lee_brands', 'lt_sc_brands');
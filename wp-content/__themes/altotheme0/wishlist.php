                ...
                if( $product !== false && $product->exists() ) : ?>
                    <tr id="yith-wcwl-row-<?php echo (int)$item['prod_id'] ?>" data-row-id="<?php echo (int)$item['prod_id'] ?>">
                        ...
                        <td class="product-remove">
                            <div>
                                <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove remove_from_wishlist" title="<?php esc_html_e( 'Remove this product', 'altotheme' ) ?>"><span class="icon-close"></span></a>
                            </div>
                        </td>
                        <?php endif; ?>

...
jQuery(document).ready(function($) {
    $('#section-demo_data .button-primary').live('click', function(e) {
        ...
        if(confirm == true) {
            ...
            jQuery('.running-import').show();

            if(!run){
                import_contents('data1', jQuery, loading_img);
                run = true;
            }
            ...
            var timeOutContent = setInterval(function(){
                console.log(act);
                if(!run){
                    import_contents('data'+(act.toString()), jQuery, loading_img);
                    run = true;
                }
            }, 1000);
            ...
            var timeOut = setInterval(function(){
                if(act > _total){
                    import_end_importer(jQuery, loading_img);

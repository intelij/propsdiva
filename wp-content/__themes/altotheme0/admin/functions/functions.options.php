...
if (!function_exists('of_options'))
{
    ...
    $of_options[] = array( 
        "name" 		=> "Disable Transition Loading",
        "desc" 		=> "Disable transition loading for all page",
        "id" 		=> "disable_wow",
        "std" 		=> 0,
        "type" 		=> "checkbox"
    );
    ...
    $of_options[] = array( 
        "name"      => "Disable Plugin Update",
        "desc"      => "Disable plugin update notice",
    ...
    $of_options[] = array( 
        "name"      => "Cache site version JS & CSS",
        "desc"      => "Cache site version",
        "id"        => "cache_version",
        "std"       => "",
        "type"      => "text"
    );
    ...
    $footers_option['default'] = 'Select the Footer type';
    ...
    $of_options[] = array(
        "name" 		=> "Main menu Transparent",
        "id" 		=> "main_menu_transparent",
    ...
    $of_options[] = array(
        ...
        "desc" 		=> "Choose breadcrumb type.",
        "id" 		=> "breadcrumb_type",
        "std" 		=> "Has background",
        "type" 		=> "select",
        "options" 	=> array(
            "Default"           => "Without Background",
            "Has background"	=> "With Background",
        ),
    ...
    $of_options[] = array(
        ...
        "desc" 		=> "Breadcrumb background image..",
        "id" 		=> "breadcrumb_bg",
    ...
    $of_options[] = array(
        "name" 		=> "Breadcrumb background color.",
    ...
    $of_options[] = array(
        "name"  => "Height breadcrumb",
        "desc" 	=> "Height breadcrumb. (px)",
    ...
    $of_options[] = array(
        "name" 		=> "Breadcrumb Text Color",
        "desc" 		=> "Change Breadcrumb Text Color",
        "id" 		=> "breadcrumb_color",
        "std" 		=> "#fff",
        "type" 		=> "color"
    );
    ...
    $of_options[] = array( 
        "name" 	=> "Text fonts (paragraphs, buttons, sub-navigations)",
        "desc" 	=> "Select heading fonts",
        "id" 	=> "type_texts",
        "std" 	=> "Lato",
        "type" 	=> "select_google_font",
    ...
    $of_options[] = array(
        "name" 		=> "Alterntative font (.alt-font)",
    ...
    $of_options[] = array(
        ...
        "desc"      => "Change border color for buttons.",
    ...
    $of_options[] = array(
        "name" 		=> "Buttons Color Hover Effect",
    ...
    $of_options[] = array(
        ...
        "options" 	=> array(
            ...
            "hover-fade" => "Fade",
            "hover-bottom-to-top" => "Bottom to top",
            "" => "No effect",
        )
    );
    ...
    $of_options[] = array(
        ...
        "desc"  => "Enable product hover black overlay on product grid page",
        "std"   => 1,
        "type"  => "checkbox"
    );
    
    $of_options[] = array(
        "name"  => "Delay overlay items",
        "desc" 	=> "(ms) Delay overlay items.",
        "id" 	=> "delay_overlay",
        "std" 	=> "100",
        "type" 	=> "text"
    );
    ...
    $of_options[] = array(
        "name" 	=> "Enable Hover product Zoom",
        "id" 	=> "product-zoom",
    ...
    $of_options[] = array( 
        ...
        "id"        => "disable-cart",
        "desc"      => "Disable add to cart button on product category page and single product page.",
        "std"       => "0",
        "type"      => "checkbox"
    );

    $of_options[] = array(
        "name" 	=> "Pagination page style",
        "id" 	=> "pagination_style",
    ...
    $of_options[] = array( 
        "name"      => "Widget variations sidebar",
        "id"        => "vari_hide_empty",
        "desc"      => "Show variation value if exist a minium product. Ex: Show RED color in Filter by Color if exist minimum a product that have RED attribute.",
        "std"       => "1",
        "type"      => "checkbox"
    );
    ...
    $of_options[] = array(
        ...
        "options"   => array(
            "left-sidebar" => "Left sidebar", 
            "right-sidebar" => "Right sidebar", 
            "no-sidebar" => "No sidebar (Centered)"
        )
    );
    ...
    $of_options[] = array(
        ...
        "desc"      => "Insert popup background color.",
    ...
    $of_options[] = array( 
        "name"  => "portfolio Lightbox",
        "desc"  => "Portfolio Lightbox",
        "id"    => "portfolio_lightbox",
        "std"   => 1,
        "type"  => "checkbox"
    );
    
    // Recent Top bar Promotion news slide
    $of_options[] = array( 
        "name" => "Promotion news",
        "type" => "heading"
    );
    ...
    $of_options[] = array( 
        "name"  => "Enable Top bar Promotion news",
        "desc"  => "checked is Enable",
        "id"    => "enable_post_top",
        "std"   => 1,
        "type"  => "checkbox"
    );
    ...
    $of_options[] = array( 
        "name"  => "Type display selected",
        "desc"  => 'Type display "My content custom" or "List posts"',
        "id"    => "type_display",
        "std"   => '0',
        "type"  => "select",
        "options" => array(
            'My content custom' => 'My content custom',
    ...
    $of_options[] = array( 
        "name"  => "My content custom",
        "desc"  => "Content display",
        "id"    => "content_custom",
    ...
    $of_options[] = array( 
        "name"  => "Category post",
        "desc"  => "Post in category selected",
        "id"    => "category_post",
        "std"   => '',
        "type"  => "select",
        "options" => lt_get_cats_array(),
        'class' => 'hidden-tag lt-list_post'
    );
    
    $of_options[] = array( 
        "name"  => "Limit posts",
        "desc"  => "Number posts display",
        "id"    => "number_post",
        "std"   => 4,
        "type"  => "text",
        'class' => 'hidden-tag lt-list_post'
    ...
    $of_options[] = array( 
        "name"  => "Slide display",
        "desc"  => "Number posts display in slide",
    ...
    $of_options[] = array( 
        "name" 		=> "Text promotion color",
        "desc" 		=> "Text promotion color",
...
function lt_get_cats_array(){
    $categories = get_categories( array(
        'taxonomy' => 'category',
        'orderby' => 'name'
    ) );
    $list = array(
        '' => esc_html__('Select category', 'altotheme')
    );
